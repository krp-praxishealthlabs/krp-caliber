...
console.log(`    ${bold('caliber onboard')}   ${dim('Onboard your project for AI-assisted development')}`);
console.log('');
...
console.log(`  ${dim('Or set ANTHROPIC_API_KEY / OPENAI_API_KEY and run caliber onboard.')}`);
console.log('');
